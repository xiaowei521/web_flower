...
<html lang="zh-CN">
	...
	<body>
		...
		<form  id="queryform" name="queryform" method="post" action="/User/findpassword" style="text-align: center;">
			<br>
			<input type="text" class="form-control" id="id" name="id" placeholder="输入您的登录账号" required> 
			<br>
