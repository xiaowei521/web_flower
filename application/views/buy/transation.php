...
<script type="text/javascript">
	...
	<form class="form-inline" role="form" id="queryform" name="queryform" method="post" action="/buyer/transaction">
		<input type="text" class="form-control" id="search_traFlowId" name="search_traFlowId" value="" placeholder="交易流水号">
...
<input type="hidden"  name="ec_s_traId" />
...
<input type="hidden"  name="ec_s_traQuantity" />
<input type="hidden"  name="ec_s_traPrice" />
<input type="hidden"  name="ec_s_traAmount" />
<input type="hidden"  name="ec_s_traBuyCommision" />
<input type="hidden"  name="ec_s_traBuyComm" />
<input type="hidden"  name="ec_s_traPay" />
