...
<script type="text/javascript">
	...
	<form class="form-inline" role="form" id="queryform" name="queryform" method="post" action="/buyer/rptBuyHisBalanceList/query">


		<input type="text" class="form-control datepicker" id="BeginDate" name="BeginDate" value="" size="10" required placeholder="起始日期" /> <input type="text"
...
<form id="ec"  action="/buyer/rptBuyHisBalanceList/query"  method="post" >
<div>
...
<input type="hidden"  name="ec_s_BtbOrigiDueAmount" />
<input type="hidden"  name="ec_s_BtbCurrBankAmount" />
<input type="hidden"  name="ec_s_BtbBankOffset" />
<input type="hidden"  name="ec_s_BtbARAmount" />
<input type="hidden"  name="ec_s_BtbAPAmount" />
<input type="hidden"  name="ec_s_BtbBankPay" />
<input type="hidden"  name="ec_s_BtbBankBack" />
<input type="hidden"  name="ec_s_BtbEndDueAmount" />
<input type="hidden"  name="ec_s_BtbFactMoney" />
</div>
...
<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
		...
		<table border="0"  cellpadding="0"  cellspacing="0"  width="100%" >
			<tr>
				...
				<table border="0"  cellpadding="1"  cellspacing="2" >
					...
					<td><select name="ec_rd"  onchange="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_crd.value=this.options[this.selectedIndex].value;document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()" >
				<option value="100"  selected="selected">100</option><option value="50" >50</option><option value="100"  selected="selected">100</option>
				</select></td>
					<td><img src="/static/components/extremetable/images/table/separator.gif"  style="border:0"  alt="Separator" /></td>
					<td><a href="javascript:document.forms.ec.ec_eti.value='ec';document.forms.ec.ec_ev.value='xls';document.forms.ec.ec_efn.value='buyHisBalanceList.xls';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"><img src="/static/components/extremetable/images/table/xls.gif"  style="border:0"  title="导出 Excel"  alt="导出XLS" /></a></td>
					</tr>
				</table></td>
			</tr>
		</table>
	...
	<tr>
		...
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_TimeSetString.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 日期" >日期</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbOrigiDueAmount.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 上日资金" >上日资金</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbCurrBankAmount.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 当日充值" >当日充值</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbBankOffset.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 冲抵欠款" >冲抵欠款</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbARAmount.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 当日应付" >当日应付</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbAPAmount.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 当日应收" >当日应收</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbBankPay.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 结算付款" >结算付款</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbBankBack.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 退款金额" >退款金额</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbEndDueAmount.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 结算后资金" >结算后资金</td>
		<td class="tableHeader"  onmouseover="this.className='tableHeaderSort';this.style.cursor='pointer'"  onmouseout="this.className='tableHeader';this.style.cursor='default'"  onclick="javascript:document.forms.ec.ec_eti.value='';document.forms.ec.ec_s_BtbFactMoney.value='asc';document.forms.ec.ec_p.value='1';document.forms.ec.setAttribute('action','/buyer/rptBuyHisBalanceList/query');document.forms.ec.setAttribute('method','post');document.forms.ec.submit()"  title="排序 当日实付" >当日实付</td>
