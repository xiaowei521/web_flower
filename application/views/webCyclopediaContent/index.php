...
<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
	...
	<form class="form-inline" role="form" id="queryform" name="queryform" method="post" action="/webCyclopediaContent">
		...
		<div class="col-md-9">
			<div class="panel panel-primary" style="margin-bottom: 10px;">
			  ...
			  ?>
					...
					共1页（6条记录） <input style="border:1px solid;width:27px;height: 27px;margin:0;text-align: center;" type="text" id="currentPage" name="currentPage" value="1"
